...
AddEventHandler('phone:getSMS', function()
    ...
    local result = exports.ghmattimysql:execute("SELECT * FROM user_messages WHERE receiver = @mynumber OR sender = @mynumber ORDER BY id DESC", 
    ...
    for i, j in pairs(numbers) do
        ...
        local data = ReverseTable(result)
